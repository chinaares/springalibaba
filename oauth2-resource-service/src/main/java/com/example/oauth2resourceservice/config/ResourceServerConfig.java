package com.example.oauth2resourceservice.config;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
   ...
   public RemoteTokenServices tokenService() {
      ...
      // 5000 端口为auth-service 的端口
      remoteTokenServices.setCheckTokenEndpointUrl("http://localhost:5000/oauth/check_token");
